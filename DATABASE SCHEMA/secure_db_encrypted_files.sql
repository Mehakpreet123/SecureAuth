...
CREATE TABLE `encrypted_files` (
  ...
  `encrypted_url` longblob NOT NULL,
  `encrypted_key` text NOT NULL,
  `uploaded_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`file_id`),
  KEY `user_id` (`uploaded_by`),
  CONSTRAINT `encrypted_files_ibfk_1` FOREIGN KEY (`uploaded_by`) REFERENCES `users` (`user_id`) ON DELETE CASCADE
